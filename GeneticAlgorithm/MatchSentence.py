...
TARGET_PHRASE = b'Have a nice day'       # target DNA
...
TARGET_ASCII = np.frombuffer(TARGET_PHRASE, dtype=np.uint8)  # convert string to number
...
if __name__ == '__main__':
    ...
    for generation in range(N_GENERATIONS):
        ...
        best_phrase = best_phrase.encode("ascii")
